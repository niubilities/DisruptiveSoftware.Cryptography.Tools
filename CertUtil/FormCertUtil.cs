namespace CertUtil
{
  ...
  public partial class FormCertUtil : Form
  {
    ...
    public FormCertUtil()
    {
      ...
      foreach (var cryptoObject in CertUtilConstants.CryptographicObjects) comboBoxObject.Items.Add(cryptoObject.Key);

      comboBoxObject.SelectedItem = comboBoxObject.Items[0];

      foreach (var pkcFormat in CertUtilConstants.PublicKeyCertificatesFormats) comboBoxFormat.Items.Add(pkcFormat.Key);
